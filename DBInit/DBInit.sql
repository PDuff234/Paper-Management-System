...
CREATE TABLE Papers(PaperID SERIAL PRIMARY KEY, Author INTEGER REFERENCES Authors, Title VARCHAR(100), URI VARCHAR(50000), Reviewer INTEGER REFERENCES Reviewers); 

...
PhoneNumber VARCHAR(10) NOT NULL, Email VARCHAR(50) NOT NULL, Username VARCHAR(20) NOT NULL, Password VARCHAR(20) NOT NULL, Genre SERIAL REFERENCES Genres); 

--Create Paper Table
CREATE TABLE Papers(PaperID SERIAL PRIMARY KEY, Author INTEGER REFERENCES Authors, Genre INTEGER REFERENCES Genres, Title VARCHAR(50), FileName VARCHAR(200) NOT NULL); 

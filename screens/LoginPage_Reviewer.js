...
const LoginPageReviewer = () => {
  ...
  const onSubmit = useCallback(formData => {
    ...
    fetch('http://localhost:5000/login/reviewers', {
      method: 'POST', 
      headers: {
    ...
    .then(data=>{
      ...
      navigation.navigate('Reviewer Page');
    })
  });
  ...
  return (
    <View style = { styles.container }>
        ...
        <TouchableOpacity>
          <Text style = {styles.forgot_button} onPress = {() => navigation.navigate('Reviewer Sign Up')}> Not a user? Register Here! </Text>
        </TouchableOpacity>
